...
add_action('wp_enqueue_scripts', 'load_stylesheets');
add_filter("use_block_editor_for_post_type", "__return_false", 100); // admin panelinde arayüz saçmi için - silebilirsin

add_theme_support("post-thumbnails"); //öne çıkan görsel
add_image_size("small", 100, 100, true); // add_image_size("large",600,600,true);
