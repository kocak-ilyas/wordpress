...
{
    wp_enqueue_style('morello-style', get_template_directory_uri() . '/style.css', array(), wp_get_theme()->get('Version'), 'all');
...
{
    wp_enqueue_script("morello-jquery", get_template_directory_uri() . "/style/js/jquery.min.js", array(), "1.11.3", true);
    wp_enqueue_script("morello-bootstrap", get_template_directory_uri() . "/style/js/bootstrap.min.js", array(), "3.3.2", true);
    wp_enqueue_script("morello-themepunch", get_template_directory_uri() . "/style/revolution/js/jquery.themepunch.tools.min.js?rev=5.0", array(), "1.6.9", true);
    wp_enqueue_script("morello-revolution", get_template_directory_uri() . "/style/revolution/js/jquery.themepunch.revolution.min.js?rev=5.0", array(), "5.2.4", true);
    wp_enqueue_script("morello-slideanims", get_template_directory_uri() . "/style/revolution/js/extensions/revolution.extension.slideanims.min.js", array(), "1.1.2", true);
    wp_enqueue_script("morello-layeranimation", get_template_directory_uri() . "/style/revolution/js/extensions/revolution.extension.layeranimation.min.js", array(), "2.2.1", true);
    wp_enqueue_script("morello-navigation", get_template_directory_uri() . "/style/revolution/js/extensions/revolution.extension.navigation.min.js", array(), "1.2.4", true);
    wp_enqueue_script("morello-carousel", get_template_directory_uri() . "/style/revolution/js/extensions/revolution.extension.carousel.min.js", array(), "1.0.2", true);
    wp_enqueue_script("morello-video", get_template_directory_uri() . "/style/revolution/js/extensions/revolution.extension.video.min.js", array(), "1.7", true);
    wp_enqueue_script("morello-plugins", get_template_directory_uri() . "/style/js/plugins.js", array(), "", true);
